...
const actionLabels: Record<string, string> = { 'upstreams.billing.authorize': '配置用量授权', 'upstreams.billing.revoke': '移除用量授权', 'auth.login': '管理员登录', 'auth.logout': '退出登录', 'auth.password': '修改密码', 'auth.revoke_others': '撤销其他会话', 'upstreams.create': '新建上游', 'upstreams.update': '修改上游', 'upstreams.delete': '删除上游', 'upstreams.models': '刷新模型目录', 'upstreams.test': '账号生成测试', 'clients.create': '创建客户端 API', 'clients.update': '修改客户端 API', 'clients.delete': '撤销客户端 API', 'clients.rotate': '轮换客户端密钥' };
